...
namespace FireIncidents.Controllers
{
    ...
    public class AlertsController : Controller
    {
        ...
        // Step 1: POST /alerts/update to save incoming tweet/alert data
        [HttpPost]
        [Route("alerts/update")]
        ...
        // Step 2 (API): GET /api/alerts to fetch latest alerts as JSON
        [HttpGet]
        [Route("api/alerts")]
        ...
        // Step 2 (Page): GET /alerts to render the alerts page
        [HttpGet]
        [Route("alerts")]
